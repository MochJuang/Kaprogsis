<section class="content">
  <ol class="breadcrumb">
        ...
        <li>Loker</li>
        <li>Data</li>
        <li class="active">Loker C(Putri)</li>
    </ol>
	<div class="btn-group">
			...
			<button type="button" class="btn btn-flat btn-primary dropdown-toggle" data-toggle="dropdown">
				...
				<ul class="dropdown-menu" role="menu">
					<li>
						<a href="<?= base_url() ?>/loker/loker_a" class="dropdown-item active">Loker A</a>						
					</li>
					<li>
	...
	<a href="<?= base_url() ?>/loker/loker_c" class="btn btn-primary active">Putri</a>
	...
	<button type="button" class="btn btn-success" data-toggle="modal" data-target="#Tambah">
         ...
         <div class="modal fade" id="Tambah">
          <div class="modal-dialog">
            	<form action="<?= base_url() ?>loker/tambah/C" method="post">
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
             <div class="box-body no-padding">
              <table class="table table-responsive table-hover tb_lokerc">
                <thead>
                	<tr>
                  <th>No Loker</th>
                  <th>Nama</th>
                ...
                <tr>
                  ...
                  <td>
                  	...
                  	<a href="<?= base_url() ?>/loker/delete/<?= $loker['id_loker'] ?>/c" class="btn btn-danger"><span class="fa fa-warning"></span></a>
									<a id="edit_loker" data-target="#update_loker" data-toggle="modal" data-id="<?= $loker['id_loker'] ?>" class="btn btn-warning"><span class="fa fa-edit"></span></a>                  </td>
                </tr>
              <?php endforeach ?>
