<section class="content">
  <ol class="breadcrumb">
        ...
        <li>Loker</li>
        <li>Data</li>
        <li class="active">Loker B(Putra)</li>
    </ol>
	<div class="btn-group">
          ...
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
              	...
              	<div class="form-group">
	                <input type="text" class="form-control" name="no_loker" placeholder="No Loker 1-20">               		
              	</div>
              	<div class="form-group">
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
             <div class="box-body no-padding">
              <table class="table table-responsive table-hover tb_lokerb">
                <thead>
                	<tr>
                  <th>No Loker</th>
                  <th>Nama</th>
